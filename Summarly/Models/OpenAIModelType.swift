...
public enum OpenAIModelType {
    ...
    public var modelName: String {
        ...
        case .chatGPT(let model): return model.rawValue
    ...
    public enum ChatTurbo:String {
        case turbo = "gpt-3.5-turbo"
        case turbo0301 = "gpt-3.5-turbo-0301"
        case gpt4 = "gpt-4"
